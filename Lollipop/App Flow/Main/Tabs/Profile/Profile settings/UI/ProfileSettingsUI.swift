...
extension ProfileSettingsView {
    func setup() {
        ...
        ProfileSettingsWireframe.createModule(ProfileSettingsRef: self)
        ...
        self.tableView.register(ProfileSettingsTableViewCell.self, forCellReuseIdentifier: CellId.profileSettingsCell.rawValue)
