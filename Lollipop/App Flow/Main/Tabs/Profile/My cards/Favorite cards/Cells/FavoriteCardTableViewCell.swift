...
class FavoriteCardTableViewCell: UITableViewCell {
    ...
    var delegate: FavoriteCardCellProtocol?
    var index: IndexPath!
    ...
    lazy var cardStack: UIStackView = {
        let stack = UIStackView(arrangedSubviews: [cardImageContainer, textStack, checkBoxContainerView])
    ...
    func configureWith(item: Card?, index: IndexPath, delegate: FavoriteCardCellProtocol) {
        self.index = index
