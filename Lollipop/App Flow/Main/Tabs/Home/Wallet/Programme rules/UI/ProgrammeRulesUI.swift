...
extension ProgrammeRulesView {
    func setup() {
        self.view.backgroundColor = AppColors.lightGrey
        ProgrammeRulesWireframe.createModule(ProgrammeRulesRef: self)
        ...
        self.navigationItem.title = LocalizedTitle.programmeRules.localized
